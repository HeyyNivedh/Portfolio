...
function DefaultBackground() {
    // Static version of the Images component to provide content for the glass shader

    return (
        <group>
            {/* Environment lighting provides the background reflections */}
        </group>
    );
}
...
}: FluidGlassProps & { children?: ReactNode; showDemoContent?: boolean }) {
...
const ModeWrapper = memo(function ModeWrapper({
    ...
    useFrame((state, delta) => {
        ...
        // Clear color set to match potential background or transparent
